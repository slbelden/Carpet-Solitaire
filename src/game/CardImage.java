...
public class CardImage extends JLabel {
	 ...
	 *            Queen, and King respectively. Number of a blank card is 14.
	...
	public Point getCenter() {
		return new Point(this.getX() + (CARD_WIDTH / 2), this.getY() + (CARD_HEIGHT / 2));
	}
	...
	/**
	 * @return the int representing the suit of this card, 1-4 for suits, 0 for blank
	 */
	public int getSuit() {
		return suit;
	}
	...
	/**
	 * @return the int representing the number of this card, 1-13 for cards, 14 for blank
	 */
	...
	/**
	 * @return the card closest to this card, measured from the center of each card
	 */
	public CardImage getNearest(){
		// must be executed in Main, since this function requires access to the playGrid
